            ...
            return (
              <Fragment key={index}>
                <div
                  ...
                  className="col-span-1 m-2 flex flex-col items-center justify-center space-y-2 cursor-pointer border border-black rounded-md p-4 mb-4 mr-4"
                >
                  <img
        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col space-y-2  w-2/3 lg:w-2/4">
            <label htmlFor="points" className="text-sm">
              Price (between 0 and 10 TND):{" "}
              <span className="font-semibold text-yellow-700">{range} TND</span>{" "}
            </label>
            <input
              value={range}
              className="slider"
