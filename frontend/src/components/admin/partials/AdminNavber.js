    ...
    <Fragment>
      <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full bg-white">
        ...
        <div className="hidden lg:block">
          ...
          >
           <span style={{ marginRight: "0.5rem" }}>HyperDev</span> <span style={{ color: "white",  border: "0.7px solid LightSteelBlue", padding: "7px" , backgroundColor: "LightSteelBlue" }}> Express</span>
          </span>
        </div>
        {/* Small Screen Show */}
